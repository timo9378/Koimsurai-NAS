                ...
                >
                  <div className="relative">
                    <Input
                      ...
                      name={`share-password-${passwordFieldId}`}
                      value={password}
 ...
 */
export function ShareDialog({ isOpen, onClose, ...rest }: ShareDialogProps) {
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      {isOpen && <ShareDialogBody onClose={onClose} {...rest} />}
    </Dialog>
  );
}
